...
config = ConfigParser()
args, v1_base_url, v1_token, a1_base_url, a1_application_id, a1_api_key, soar_base_url, soar_api_key, cloud_app_sec_base_url, cloud_app_sec_api_key, c1_base_url, c1_token, headers = [None] * 13
